// save.js — 10 slots em localStorage.
//
...
export const save = {
  // Devolve sempre 10 posicoes; slot vazio vem como null. Os tres arquivos
  // antigos continuam nas mesmas chaves e aparecem normalmente.
  list() {
    const out = [];
