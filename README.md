...
| **Mouse up / down** | Raise and lower the barrel while aiming |
| **Mouse left / right** | Turn David to the opposite side without lowering the gun |
| **Left mouse** | Fire |
| `R` | Reload |
| `Esc` | Pause / back |
...
The main menu has a **Test Room** for stepping through every animation and a
separate **Combat Arena** for wounds, bullet penetration and Frenzy finishers.
